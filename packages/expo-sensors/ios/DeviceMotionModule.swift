  ...
  private func startDeviceMotionUpdates() {
    ...
    motionManager.startDeviceMotionUpdates(using: referenceFrame, to: operationQueue) { [weak self] data, _ in
      ...
      self?.sendEvent(EVENT_DEVICE_MOTION_DID_UPDATE, [
        ...
        "interval": Double(motionManager.deviceMotionUpdateInterval)
      ])
    }
  }
}

private func getAttitudeReferenceFrame() -> CMAttitudeReferenceFrame {
...
private func getDeviceOrientationRotation() -> Int {
